...
const projectSchema = Yup.object().shape({
    ...
    igk: Yup.string(),
    budget: Yup.number().positive('Бюджет должен быть положительным').required('Поле бюджет обязательно для заполнения'),
    ...
    contentFormats: Yup.array().of(Yup.object().shape({
        ...
        contentCount: Yup.number().positive('Количество контента должно быть положительным').required('Не выбрано contentCount'),
    ...
    channels: Yup.array().of(Yup.object().shape({
        ...
        planPublicationCount: Yup.number().positive('Количество публикаций должно быть положительным').required('Не выбрано planPublicationCount'),
        internetResourceId: Yup.string().required('Не выбран internetResourceId')
    })),
    kpis: Yup.array().of(Yup.object().shape({
        id: Yup.string(),
        planCount: Yup.number().positive('Количество КПЭ должно быть положительным').required('Не выбрано planCount'),
